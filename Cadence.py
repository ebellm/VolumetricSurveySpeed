...
class Survey():
    ...
    def sky_limited_cadence_subnight(self, max_zenith_angle=66.4):
        ...
        if omega_dot >= dov_dt:    # camera surveys faster than sky rotates out
            ...
            # have to use a subset of the sky. consider the non-circumpolar area
    ...
    def yearly_cadence_points(self, cadence_days, twilight=18.):
        ...
        deltas = N.linspace(0,n_grid_points-1,n_grid_points)*cadence_days*u.day
...
class EvryscopeSurvey(Survey):
    ...
    def snapshot_size(self, cadence_days, doy=0, max_zenith_angle=66.4,
        ...
        if max_zenith_angle < 60:
            raise NotImplementedError('Need to scale fov for small zenith angs')
...
HSC = Survey(name='HSC', lat=19.83, fov=N.pi*(45./60.)**2., overhead=40., optimal_exposure=100., saturation=18.6,limiting_mag = 25, color='#660066', dates = [2014, 2020])
...
ASASSN = Survey(name='ASAS-SN 1', lat=20.71, fov=73., overhead=23., optimal_exposure=180., saturation=8,limiting_mag = 17, color='#990000', dates = [2013, 2017])

surveys = [PTF, ZTF, PS1, PS12, BlackGEM4, CRTS, CRTS2, DECam, ATLAS, LSST, EvryScope, ASASSN, HSC]
